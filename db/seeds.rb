...
an7 = Animal.create(name: "Monkey", age: 2, gender: "Female", kind: "Cat", breed: "Domestic Medium hair", shelter: sh1, temperament: "Sweet", picture: "https://petharbor.com/get_image.asp?RES=Detail&ID=A344555&LOCATION=DNVR")
an8 = Animal.create(name: "Tango", age: 3, gender: "Male", kind: "Cat", breed: "Domestic Shorthair", shelter: sh1, temperament: "Scrappy", picture: "https://petharbor.com/get_image.asp?RES=Detail&ID=A345197&LOCATION=DNVR")
an9 = Animal.create(name: "Tansy", age: 1, gender: "Male", kind: "Cat", breed: "Domestic Shorthair", shelter: sh1, temperament: "Docile", picture: "https://petharbor.com/get_image.asp?RES=Detail&ID=A345209&LOCATION=DNVR")
an10 = Animal.create(name: "Carly", age: 8, gender: "Female", kind: "Cat", breed: "Domestic Shorthair", shelter: sh2, temperament: "Timid", picture: "http://www.petharbor.com/get_image.asp?RES=thumb&ID=A0601865&LOCATION=DDFL")
an11 = Animal.create(name: "Dustin", age: 7, gender: "Male", kind: "Cat", breed: "Domestic Shorthair", shelter: sh2, temperament: "Affectionate", picture: "http://www.petharbor.com/get_image.asp?RES=thumb&ID=A0658581&LOCATION=DDFL")
an12 = Animal.create(name: "Oreo", age: 1, gender: "Male", kind: "Cat", breed: "Domestic Shorthair", shelter: sh3, temperament: "Alert", picture: "http://petharbor.com/get_image.asp?RES=Detail&ID=A208313&LOCATION=AURO")
an13 = Animal.create(name: "Herman", age: 4, gender: "Male", kind: "Cat", breed: "Domestic Shorthair", shelter: sh4, temperament: "Shy", picture: "https://www.hsppr.org/sites/default/files/images/petharbor/A1459014.jpg")
